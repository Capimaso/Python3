...
>> matequiz.py echo.        questionDifficult = int(input('Qual dificuldade gostaria de jogar?\n1-Fácil\n2-Médio\n3-Difícil\n'))
...
>> matequiz.py echo.        #Posiciona os numeros baseados nas preferencias de sinais usados na array sinais lá em cima
...
>> matequiz.py echo.        else:
>> matequiz.py echo.            print('Resposta errada!')
...
>> matequiz.py echo.            os.system('cls')
>> matequiz.py echo.            print('Como jogar?\n As regras sao básicas, escolha uma quantidade de questoes para resolver, apos isso leia a questao e responda o resultado da conta, e se errar 3 vezes, o jogo acaba!')
